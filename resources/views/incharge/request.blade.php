    ...
    <div class="panel panel-{{ $jobRequest->indication() }}">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              @if($jobRequest->recommended())
                <p>Do you really want to remove your recommendation to this request?</p>
              @else
                <p>Do you really want to recommend this request?</p>
              @endif
            </div>
            <div class="modal-footer">
              <form class="" action="{{ $jobRequest->recommended()? '/incharge/unrecommend' : '/incharge/recommend' }}" method="post">
                {{ csrf_field() }}
      ...
      <div class="panel-body">
        ...
        <div class="row">
          <div class="col-sm-12">
            @if($jobRequest->recommended())
              <a href="#myModal" data-toggle="modal" class="btn btn-danger pull-right {{ $jobRequest->approved()? 'disabled': '' }}"><span class="glyphicon glyphicon-remove"></span>Cancel</a>
            @else
