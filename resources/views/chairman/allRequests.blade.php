...
<script type="text/javascript" src="{{ asset('js/client/allrequests.js') }}">
...
<div class="container">
    <div class="row">
        <div class="row">
          <div class="col-sm-6">
            <h2 class="pull-left">All Requests</h2>
          </div>
        ...
        <div class="talble-responsive">
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr class="clickable-row {{ $jobRequest->indication() }}" data-href="/chairman/request/{{ $jobRequest->requestID }}">
                <td>{{ $jobRequest->getClient->getUser->fullName }}</td>
                <td>{{ $jobRequest->requisitioningUnit }}</td>
                <td class="{{ $jobRequest->assigned()? 'text-success' : 'text-danger' }}">
